...
Observando los valores extremos que tenemos en nuestros datos, las variables estudiadas y l distribución de los demás valores, se han decidido mantente intactos tal cual están.  
...
La primera sería ver el impacto del nivel socioeconómico en la supervivencia, es decir, si los ricos se han salvado en su mayor parte frente a los pobres.  
Otro tema a analizar sería el impacto de la clase de viaje en el precio o si existe relación entre el precio pagado y la edad de los viajeros.  
...
También tendremos presente la hipótesis de si la mayor edad va unida a mayor mortalidad o no.
Por último nos gustaría comprobar una frase que es muy mítica en las películas, 'Las mujeres y los niños primero', para ello vamos a analizar por sexo.  
...
* Cómo primer objeto de análisis se quiso estudiar si la edad de los viajeros influía en el precio que estos paganban por subir a bordo. Del análisis estadístico extrajimos que la relación entra ambas variables era muy pequeña y mediante el análisis visual pudimos ver como el precio pagado por el pasaje no sufría variaciones de distribución significativas conforme avanzamos en la edad.  

* Cómo segundo objetivo teníamos el averiguar si el precio del billete era insensible al cambio de clase, algo que mediante el test realizado quedó falsado con un p_valor muy por debajo del límite 0.05. Esto nos indicaba que habías variaciones en el precio según la clase en la que se viajase. Para complementar este análisis y ver como eran esas variaciones, realizamos la graficación boxplot que nos mostró como la primera clase era la más cara con diferencia, siendo la más barata la tercera clase. Al carecer de fechas de compra de los billetes, no podemos ahondar más en neustro análisis.  
